...
assert near_duplicates(questions, shingle_words=4, num_perm=64, threshold=0.85) == []
PY
then
  ok "кандидат MinHash с Жаккаром 0,80 не удалён при пороге 0,85"
else
  fail "LSH удалил пару с Жаккаром ниже настроенного порога"
fi
